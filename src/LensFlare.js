...
export function LensFlareEffect(lensPosition, opacity) {
  LensFlareParams = {
    lensPosition: lensPosition ? lensPosition : new THREE.Vector3(12, 20, -80),
  ...
  const lensFlareMaterial = new THREE.ShaderMaterial({
    uniforms: {
      ...
      enabled: { value: true },
      colorGain: { value: new THREE.Color(255, 255, 0) },
      starPoints: { value: 5.0 },
      glareSize: { value: 0.0225 },
      flareSize: { value: 0.004 },
      flareSpeed: { value: 0.2 },
      flareShape: { value: 0.6 },
      haloScale: { value: 0.25 },
